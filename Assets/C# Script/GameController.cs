...
public class GameController : MonoBehaviour
{
    ...
    public float SpawnValuesX,SpawnValuesYLower,SpawnValuesYUpper,TimeBetweenSpawns,TimeBetweenWaves,ReducedTimeBetWaves;
    public int ZombiesCount,IncreaseZombies;
